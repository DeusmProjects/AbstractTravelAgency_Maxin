...
namespace AbstractTravelAgencyRestApi
{
    ...
    public static class UnityConfig
    {
        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            ...
            container.RegisterType<IConditionService, ConditionServiceDB>(new HierarchicalLifetimeManager());
            container.RegisterType<IVoucherService, VoucherServiceDB>(new HierarchicalLifetimeManager());
